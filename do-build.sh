...
TARGET_ARCH="amd64"
TARGET_NAME="anduinos-kde-plasma"
TARGET_BUSINESS_NAME="AnduinOS-Kde-Plasma"
TARGET_HOSTNAME="anduinos-kde-plasma"
...
TARGET_ANDUINOS_CODENAME="${TARGET_ANDUINOS_CODENAME}"
TARGET_ANDUINOS_MIRROR="${TARGET_ANDUINOS_MIRROR}"
...
function core_var_dump () {
	...
	echo "TARGET_ANDUINOS_CODENAME=\${TARGET_ANDUINOS_CODENAME}"
	echo "TARGET_ANDUINOS_MIRROR=\${TARGET_ANDUINOS_MIRROR}"
...
function core_var_export () {
	...
	export TARGET_ANDUINOS_CODENAME
	export TARGET_ANDUINOS_MIRROR
